"""
==============================================================================
DSCN-G-BIO EXPERIMENTAL SCRIPT v4.0: THE THREE-PHASE MODEL OF DEEP COMPREHENSION
==============================================================================

ACTUALIZADO v4.0 PARA COINCIDIR CON APÉNDICE B DEL PAPER:
...
def generate_synthetic_eeg(n_samples=5000, fs=250, insight_point=3500, 
    ...
    # 4. INYECCIÓN DE ARTEFACTO EMG (v4.0 - Apéndice B.3.1)
    if inject_emg:
...
# =============================================================================
# SECCIÓN 6: PIPELINE PRINCIPAL DE ANÁLISIS
# =============================================================================
...
def test_prediction_p5(t, alpha_wpli, insight_time_sec=16.0):
    ...
    pre_end = int((insight_time_sec - 2) * 250)    alpha_pre = alpha_wpli[pre_start:pre_end]
...
if __name__ == "__main__":
    print("=" * 80)
    print("DSCN-G-BIO PIPELINE TEST v4.0 - MODELO DE TRES FASES")
    print("=" * 80)
    print()
